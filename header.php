...
<?php do_action( 'cdmdirect_site_before' ); ?>

<div id="page" class="min-h-screen flex flex-col">

	<?php do_action( 'cdmdirect_header' ); ?>
	...
	<div id="content" class="site-content flex-grow">
		...
		<?php if ( is_front_page() ) { ?>
			...
			<div class="container mx-auto my-12 border-b pb-12">
				<h1 class="font-bold text-lg text-secondary uppercase">cdm</h1>
				...
				<p class="max-w-screen-lg text-gray-700 text-lg font-medium mb-10">cdm is your go-to starting
					point for developing WordPress themes with TailwindCSS and comes with basic block-editor support out
					of the box.</p>
				<a href="https://github.com/jeffreyvr/cdm"
		...
		<?php do_action( 'cdmdirect_content_start' ); ?>
