      ...
      <div class="flex justify-end items-center gap-x-6">
        <div class="main-nav--div flex gap-x-10 items-center shadow-[0_1px_0px_rgba(255,255,255,0.5)]">
          <ul class="main-nav--ul flex gap-x-12 text-white font-medium uppercase">
            <li><a href="/" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Home</a></li>
            <li><a href="/our-services" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Services</a></li>
            <li><a href="/industry" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Industry</a></li>
            <li><a href="/resources" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Resources</a></li>
            <li><a href="/about-us" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">About</a></li>
            <li><a href="/contact-us" class="inline-block whitespace-nowrap py-8 px-3 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Contact Us</a></li>
          </ul>
