<header class="site-header fixed w-full top-0 left-0 right-0 z-30">
  ...
  <div id="main-nav" class="py-3 md:py-3 xl:py-6 transition duration-300">
    <div class="max-w-screen-4xl mx-auto px-4 md:px-6 xl:px-8">
      <div class="flex justify-between items-center">
        ...
        <div class="hidden lg:flex justify-end items-center gap-x-6 4xl:gap-x-12">
        ...
        <button type="button" id="mobilemenu-open" class="p-2 text-white lg:hidden">
