          ...
          ?>
            <ul class="main-nav--ul flex gap-x-12 3xl:gap-x-14 4xl:gap-x-16">
              <?php foreach ($menu_items as $menu_id => $menu) : ?>
                ...
                <?php endif; ?>
              <?php endforeach; ?>
              <li class="hoverable"><a href="<?php echo get_site_url() ?>/industry" class="relative inline-block text-white font-medium uppercase whitespace-nowrap py-8 px-4 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Industry</a>
                <div class="mega-menu" tabindex="0">
                  <div class="container max-w-screen-xl mx-auto">
                    <div class="flex gap-x-12 divide-x divide-white/30">
                      <div class="w-1/4">
              ...
              <li><a href="<?php echo get_site_url() ?>/resources" class="inline-block text-white font-medium uppercase whitespace-nowrap py-8 px-4 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Resources</a></li>
              <li><a href="<?php echo get_site_url() ?>/about-us" class="inline-block text-white font-medium uppercase whitespace-nowrap py-8 px-4 border-b-4 border-transparent hover:border-brand-orange transition duration-300">About</a></li>
              <li><a href="<?php echo get_site_url() ?>/contact-us" class="inline-block text-white font-medium uppercase whitespace-nowrap py-8 px-4 border-b-4 border-transparent hover:border-brand-orange transition duration-300">Contact Us</a></li>
            </ul>
          <?php endif; ?>
