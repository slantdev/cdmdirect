<?php
?>
<div id="mobilemenu" class="h-screen w-[300px] bg-brand-bluedark fixed top-0 right-0 px-8 pt-16 pb-20 z-50 translate-x-full transition duration-300 ease-in-out">
