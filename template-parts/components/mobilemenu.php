<?php
?>
<div id="mobilemenu" class="h-screen w-[300px] bg-brand-bluedark fixed top-0 right-0 pl-8 pr-2 pt-16 pb-20 z-50 translate-x-full transition duration-300 ease-in-out">
    ...
    ?>
      <div class="flex justify-center">
        <ul class="top-nav--ul flex gap-x-4">
          <?php if ($twitter) : ?>
            <li><a class="text-white/70 hover:text-white" href="<?php echo $twitter['url'] ?>" target="<?php echo $twitter['target'] ?>"><?php echo cdmdirect_icon(array('icon' => 'twitter', 'group' => 'social', 'size' => '24', 'class' => '')); ?></a></li>
          <?php endif; ?>
          <?php if ($facebook) : ?>
            <li><a class="text-white/70 hover:text-white" href="<?php echo $facebook['url'] ?>" target="<?php echo $facebook['target'] ?>"><?php echo cdmdirect_icon(array('icon' => 'facebook', 'group' => 'social', 'size' => '24', 'class' => '')); ?></a></li>
          <?php endif; ?>
          <?php if ($linkedin) : ?>
            <li><a class="text-white/70 hover:text-white" href="<?php echo $linkedin['url'] ?>" target="<?php echo $linkedin['target'] ?>"><?php echo cdmdirect_icon(array('icon' => 'linkedin', 'group' => 'social', 'size' => '24', 'class' => '')); ?></a></li>
          <?php endif; ?>
          <?php if ($email) : ?>
            <li><a class="text-white/70 hover:text-white" href="<?php echo $email['url'] ?>" target="<?php echo $email['target'] ?>"><?php echo cdmdirect_icon(array('icon' => 'mail', 'group' => 'utilities', 'size' => '24', 'class' => '')); ?></a></li>
          <?php endif; ?>
          <?php if ($phone) : ?>
            <li><a class="text-white/70 hover:text-white" href="<?php echo $phone['url'] ?>" target="<?php echo $phone['target'] ?>"><?php echo cdmdirect_icon(array('icon' => 'phone', 'group' => 'utilities', 'size' => '24', 'class' => '')); ?></a></li>
          <?php endif; ?>
        </ul>
      </div>
    <?php endif; ?>
