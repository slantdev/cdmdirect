...
<section class="bg-black relative h-[60vh]">
  ...
  <div class="container max-w-screen-xl relative z-10 pt-[216px] pb-10 h-full">
    <div class="flex h-full items-center text-white">
      <div class="w-1/2">
        <h1 class="font-bold text-[50px] leading-tight">Outsource</h1>
        <div class="mt-6">
...
<div class="bg-brand-graylight py-6">
  <div class="container max-w-screen-xl">
    <div class="flex gap-x-3 text-slate-800"><a href="#" class="hover:text-brand-blue">Home</a> <span>/</span> <a href="#" class="hover:text-brand-blue">Our Services</a> <span>/</span> <span class="font-bold">Outsource</span></div>
  </div>
</div>

<section class="bg-brand-blue py-28">
  <div class="container max-w-screen-xl text-white">
    <div class="flex gap-x-16">
      <div class="w-2/5">
        <h2 class="text-[34px] font-bold">Planning To Outsource Your Customer Support Centre Within Australia & New Zealand?</h2>
      </div>
      <div class="w-3/5">
        <div class="text-white">
          <p class="text-2xl mb-6">CDM Direct Can Help. Our 24/7 operations will ensure that your valuable customers have experts to handle their queries – voice or digital.</p>
