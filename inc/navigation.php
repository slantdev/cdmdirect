 ...
 * @return array
 */
function cdmdirect_nav_menu_add_li_class($classes, $item, $args, $depth)
{
...
add_filter('nav_menu_css_class', 'cdmdirect_nav_menu_add_li_class', 10, 4);
 ...
 * @return array
 */
function cdmdirect_nav_menu_add_submenu_class($classes, $args, $depth)
{
...
add_filter('nav_menu_submenu_css_class', 'cdmdirect_nav_menu_add_submenu_class', 10, 3);
